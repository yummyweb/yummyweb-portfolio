...
My workplace uses gitlab and they support <a href="/" className="link"><span data-content="Lorem ipsum" className="dotted">Lorem ipsum</span></a> one of which is creating a Merge Request (Pull Request equivalent for Github). Thanks to this you can easily create a Gitlab merge request using the CLI. Let me present you the alias `git newmr`, allowing you to do all of the above things with one command!
