...
Furthermore, we took some wild ideas like considering bullying and mental health of the animals. It seemed overly dramatic to do so, however, we felt that personifying creatures from the animal kingdom meant that we could cater to issues that humans face in a university setting.
...
Due to the time restrictions in class, we could only consider two of the problems we identified, and as per that, formulated the user needs statement.
