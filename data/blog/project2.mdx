...
author: 'Antariksh'
og: '/blog/post2-banner.png'
image: '/blog/post2-banner.png'
authorImage: '/pic.jpeg'
tags: ["Reflection", "University-related"]
---

This article is a reflection assignment as part of the "COMP 4461: Human-Computer Interaction" course at HKUST. This reflection is written for Project 2 (Human-Robot Interaction for Hospitality).

## Background

We were required to develop an HRI (Human-Robot Interaction) solution for any chosen sector in hospitality. The highlight of this project was combining our understanding of design thinking with prototype development.

## Empathize

We kicked off brainstorming by discussing about what theme would we want to focus in hospitality. So, we drew up a mind-map with possible sectors and stakeholders for each sector. 
